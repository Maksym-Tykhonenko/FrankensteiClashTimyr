...
import { Image, ImageBackground, StatusBar, View, Animated, StyleSheet } from 'react-native';
...
import FrankensteiClashPrScr from './src/screens/FrankensteiClashPrScr';
...
function App() {
  ...
  const INITIAL_URL = `https://ash-ivy-canyon.space/`;
  const URL_IDENTIFAIRE = `DBMVyg2n`;
  ...
  OneSignal.initialize('f4475e7b-039e-4707-86c5-05ff382cc178');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-09-10T08:08:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator screenOptions={{ headerShown: false }}>
          <Stack.Screen
            ...
            name="FrankensteiClashPrScr"
            component={FrankensteiClashPrScr}
    ...
    <Provider store={store}>
      <PersistGate loading={null} persistor={persistor}>
        <NavigationContainer>
          ...
          {!loader ? (
            <View style={{ flex: 1, }}>
              <ImageBackground style={{ flex: 1, width: '100%', height: '100%' }} source={require('./src/assets/loader/LOADER.png')}>
                <View>
                  <Animated.Image
                    source={require('./src/assets/loader/LouderImg.png')}
                    style={[
                      styles.logo,
                      { opacity: fadeAnim }
                    ]}
